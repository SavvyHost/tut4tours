...
const HeroSectionBlogs: React.FC<HeroSectionBlogsProps> = ({ DetailBlogs }) => {
  return (
    <div className="relative w-full h-[50vh] md:h-[60vh] bg-gray-200 ">
      ...
      {/* Blurred Card */}
      <div className="absolute inset-x-4 transform translate-y-16 md:inset-x-8 bottom-8 md:bottom-12 mx-auto p-4 md:p-6  bg-opacity-40 backdrop-blur-md rounded-sm shadow-lg max-w-xs md:max-w-3xl h-auto flex flex-col items-center justify-between">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-xl md:text-2xl font-extrabold text-white mb-2 md:mb-4">
            {DetailBlogs?.title}
          </h1>
          <p
