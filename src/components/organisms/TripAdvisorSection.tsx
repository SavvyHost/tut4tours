    ...
    <div className="flex flex-col md:flex-row ">
      ...
      <div className="w-full md:w-1/4 mb-6 md:mb-0 md:pr-4 ">
        <div className="flex items-center justify-center mb-5">
          <Image src={TripLogo} alt="Trustpilot logo" width={150} height={50} />
        </div>
        <div className="items-center justify-center flex flex-col">
          ...
          <h2 className="text-lg text-center font-semibold mb-2 items-center justify-center flex ">
            Excellent Based on 223,512 reviews
          </h2>
        </div>
      </div>
