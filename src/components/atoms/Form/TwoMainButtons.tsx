    ...
    <div>
      <div className="absolute inset-0 flex flex-col justify-center items-center mt-20 p-4">
        <h1 className="text-4xl sm:text-5xl capitalize text-white font-bold lg:text-6xl font-segoe text-center mb-4 lg:mb-6">
          Egypt Tut4tours Tours With The Best Locals Ever!
        </h1>
        <p className="text-lg sm:text-xl capitalize text-white font-bold font-segoe lg:text-2xl text-center mb-8 lg:mb-10">
          Confused? Want to Egypt Tut4tours your dream package? Enquire here in
          1 min.
        </p>
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0">
          <Link href="/inquire" passHref>
            <button className="bg-yellow-800 capitalize font-segoe text-white font-semibold py-3 px-8 lg:py-4 lg:px-10 rounded-md mb-4 sm:mb-0 sm:mr-4 shadow-lg transition-all duration-300 ease-in-out hover:bg-yellow-950 hover:border-gray-300 hover:text-yellow-400 hover:shadow-xl transform hover:scale-105">
              Tailor Made
            </button>
          </Link>
        </div>
