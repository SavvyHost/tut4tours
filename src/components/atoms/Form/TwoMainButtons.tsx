    ...
    <div>
      <div className="absolute inset-0 flex flex-col justify-center items-center mt-20 p-4">
        <h1 className="text-4xl sm:text-5xl capitalize text-white font-bold lg:text-6xl font-segoe text-center mb-4 lg:mb-6">
          Egypt Travel Lite Tours With The Best Locals Ever!
        </h1>
        <p className="text-lg sm:text-xl capitalize text-white font-bold font-segoe lg:text-2xl text-center mb-8 lg:mb-10">
          Confused? Want to Egypt Travel Lite your dream package? Enquire here
          in 1 min.
        </p>
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0">
          <Link href="/inquire" passHref>
            <button className="bg-blue-800 capitalize font-segoe text-white font-semibold py-3 px-8 lg:py-4 lg:px-10 rounded-md mb-4 sm:mb-0 sm:mr-4 shadow-lg transition-all duration-300 ease-in-out hover:bg-blue-950 hover:border-gray-300 hover:text-blue-400 hover:shadow-xl transform hover:scale-105">
              Tailor Made
            </button>
          </Link>
        </div>
      ...
      >
        <div className="flex flex-row items-center justify-center space-x-2 px-4">
          <Link href="/inquire" className="w-full">
            <button className="w-full bg-blue-500 hover:bg-blue-600 text-white font-normal text-nowrap py-2 px-4 rounded-md shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1">
              Inquire Now
            </button>
          </Link>
          ...
          <Link href="/top-excursions" className="w-full">
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-normal text-nowrap py-2 px-4 rounded-md shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1">
